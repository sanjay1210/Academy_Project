		...
		try {
			...
			Statement stmt = con.createStatement();
                        ...
                        if(column_name.equals("avg")){
                            query = "Select studentName,(subject1+subject2+subject3)/3 from students order by (subject1+subject2+subject3)/3 DESC LIMIT 5";
                        }
                        else{
                            query = "Select studentName,"+column_name+" from students order by "+column_name+" DESC LIMIT 5";
                        }
